...
docker cp %IJCAI19_ROOT%\IJCAI19_AliAAAC\IJCAI19\submission\%SUBMISSION_FOLDER%\run.sh %TARGET_CONTAINER%:/competition
docker cp %IJCAI19_ROOT%\IJCAI19_AliAAAC\IJCAI19\submission\%SUBMISSION_FOLDER%\attack.py %TARGET_CONTAINER%:/competition
docker cp %IJCAI19_ROOT%\IJCAI19_AliAAAC\IJCAI19\submission\%SUBMISSION_FOLDER%\requirements.txt %TARGET_CONTAINER%:/competition
